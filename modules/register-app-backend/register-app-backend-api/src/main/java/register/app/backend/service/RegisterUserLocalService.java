...
/**
 * Provides the local service interface for RegisterUser. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see RegisterUserLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface RegisterUserLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>register.app.backend.service.impl.RegisterUserLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the register user local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link RegisterUserLocalServiceUtil} if injection and service tracking are not available.
	 */
	public RegisterUser addRegisterUser(
	...
	public RegisterUser updateRegisterUser(
			...
			String descriptionInput, ServiceContext serviceContext)
		throws PortalException;
