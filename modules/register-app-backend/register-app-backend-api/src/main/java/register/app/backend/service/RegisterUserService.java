...
/**
 * Provides the remote service interface for RegisterUser. Methods of this
 * service are expected to have security checks based on the propagated JAAS
 * credentials because this service can be accessed remotely.
 *
 * @author Brian Wing Shun Chan
 * @see RegisterUserServiceUtil
 * @generated
 */
@AccessControlled
@JSONWebService
...
public interface RegisterUserService extends BaseService {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>register.app.backend.service.impl.RegisterUserServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the register user remote service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link RegisterUserServiceUtil} if injection and service tracking are not available.
	 */
