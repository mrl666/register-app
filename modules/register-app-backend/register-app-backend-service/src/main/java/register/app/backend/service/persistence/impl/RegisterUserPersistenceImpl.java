...
public class RegisterUserPersistenceImpl
	...
	public void clearCache(RegisterUser registerUser) {
		...
		clearUniqueFindersCache((RegisterUserModelImpl)registerUser, true);
	}
	...
	protected void clearUniqueFindersCache(
		RegisterUserModelImpl registerUserModelImpl, boolean clearCurrent) {

		if (clearCurrent) {
			Object[] args = new Object[] {
				registerUserModelImpl.getUuid(),
				registerUserModelImpl.getGroupId()
			};
		...
		if ((registerUserModelImpl.getColumnBitmask() &
			 _finderPathFetchByUUID_G.getColumnBitmask()) != 0) {

			Object[] args = new Object[] {
				registerUserModelImpl.getOriginalUuid(),
				registerUserModelImpl.getOriginalGroupId()
			};
	...
	public RegisterUser updateImpl(RegisterUser registerUser) {
		...
		if (isNew && (registerUser.getCreateDate() == null)) {
			if (serviceContext == null) {
				registerUser.setCreateDate(now);
			}
			else {
				registerUser.setCreateDate(serviceContext.getCreateDate(now));
			}
		}

		if (!registerUserModelImpl.hasSetModifiedDate()) {
			if (serviceContext == null) {
				registerUser.setModifiedDate(now);
			}
			else {
		...
		if (isNew) {
			Object[] args = new Object[] {registerUserModelImpl.getUuid()};
			...
			args = new Object[] {
				registerUserModelImpl.getUuid(),
				registerUserModelImpl.getCompanyId()
			};
			...
			if ((registerUserModelImpl.getColumnBitmask() &
				...
				args = new Object[] {registerUserModelImpl.getUuid()};
			...
			if ((registerUserModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
					registerUserModelImpl.getOriginalUuid(),
					registerUserModelImpl.getOriginalCompanyId()
				};
		...
		clearUniqueFindersCache(registerUserModelImpl, false);
	...
	public void activate() {
		_finderPathWithPaginationFindAll = new FinderPath(
			RegisterUserImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"findAll", new String[0]);

		_finderPathWithoutPaginationFindAll = new FinderPath(
			RegisterUserImpl.class, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
			"findAll", new String[0]);
		...
		_finderPathWithoutPaginationFindByUuid = new FinderPath(
			...
			RegisterUserModelImpl.UUID_COLUMN_BITMASK |
			RegisterUserModelImpl.NATIONALID_COLUMN_BITMASK);
		...
		_finderPathFetchByUUID_G = new FinderPath(
			RegisterUserImpl.class, FINDER_CLASS_NAME_ENTITY, "fetchByUUID_G",
			new String[] {String.class.getName(), Long.class.getName()},
			RegisterUserModelImpl.UUID_COLUMN_BITMASK |
			RegisterUserModelImpl.GROUPID_COLUMN_BITMASK);
		...
		_finderPathWithoutPaginationFindByUuid_C = new FinderPath(
			...
			new String[] {String.class.getName(), Long.class.getName()},
			RegisterUserModelImpl.UUID_COLUMN_BITMASK |
			RegisterUserModelImpl.COMPANYID_COLUMN_BITMASK |
			RegisterUserModelImpl.NATIONALID_COLUMN_BITMASK);
	...
	static {
		try {
			Class.forName(RegisterAppPersistenceConstants.class.getName());
		}
